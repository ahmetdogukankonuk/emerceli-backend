                    ...
                    <div class="row">
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <?php $image = get_special_product_cover_image($special_product->id); $image = ($image) ? base_url("panel/uploads/special_products_v/$image") : base_url("assets/img/default.jpg"); ?>
                                        <img class="rounded mt-5" src="<?php echo $image; ?>" class="d-block w-100" alt="<?php echo $special_product->title; ?>">
                                    </div>
                                    <?php foreach($special_product_images as $image) { ?>
                                        <div class="carousel-item">
                                            <img class="rounded mt-5" src="<?php echo base_url("panel/uploads/special_products_v/$image->imgUrl");?>" class="d-block w-100" alt="<?php echo $special_product->title; ?>">
                                        </div>
                                    <?php } ?>
                                </div>
                        ...
                        <div class="col-lg-12 bg-light rounded-3">
                            <div class="ps-lg-4 pb-5">
                                <h3 class="mt-4 mb-3 text-center section-title"><?php echo $special_product->title; ?></h3>
