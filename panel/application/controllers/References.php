    ...
    public function add_reference()
{
    ...
    if (empty($_FILES["imgUrl"]["name"])) {
        ...
        redirect(base_url("references/new"));
    }

    $this->form_validation->set_rules("title", "Reference Name English", "required|trim");
    ...
    $insert = $this->references_model->add(array(
    ...
    public function delete($id) {
        ...
        $fileName = $this->references_model->get(array("id" => $id));
