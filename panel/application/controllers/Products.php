...
class Products extends MY_Controller {
    ...
    public function new_form(){
        ...
        $viewData->brands = $this->brands_model->get_brands(
            array(
                "isActive"  => 1
            )
        );
        ...
        if($validate){
            ...
            $insert = $this->products_model->add(
                array(
                    ...
                    "description_ru"        => $this->input->post("description_ru"),
                    "description_de"        => $this->input->post("description_de"),
                    "description_pt"        => $this->input->post("description_pt"),
                    "description_fa"        => $this->input->post("description_fa"),
    ...
    public function image_upload($id){
        ...
        if(!isAllowedWriteModule() || empty($_FILES["file"]) || !in_array($_FILES["file"]["type"], array("image/jpeg", "image/png", "image/webp"))){
            die();
        }
