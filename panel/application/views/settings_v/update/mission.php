                                    ...
                                    <div class="card-body mx-2">
                                        <form action="<?php echo base_url("settings/mission_update"); ?>" method="post">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mb-3 mt-3">
                                                        <label for="text" class="form-label text-color"><?php echo $this->lang->line('mission'); ?></label>
                                                        <textarea name="text" class="form-control" id="text" placeholder="<?php echo $this->lang->line('mission'); ?>" cols="30" rows="12"><?php echo $mission->text; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
