        <div class="px-4 page-title title-color">
            <h3> <?php echo $this->lang->line('references'); ?> </h3>
            <a href="<?php echo base_url("references/new") ?>" class="btn add-new-button text-white rounded-4 shadow float-end">
                                            ...
                                            <tr id="ord-<?php echo $item->id; ?>">
                                                ...
                                                <td>
                                                    <div class="form-check form-switch d-flex justify-content-center">
                                                        <input 
                                                            data-url="<?php echo base_url("references/isOnMainSetter/$item->id"); ?>"
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center">
                                                        <a href="<?php echo base_url("references/update/$item->id"); ?>">
                                                            <i class="bi bi-pencil-square fs-5 text-info mx-2"></i>
                                                        </a>
                                                        <a class="remove-btn" data-url="<?php echo base_url("references/delete/$item->id"); ?>">
