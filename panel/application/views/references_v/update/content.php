                    ...
                    <div class="col-12">
                        <div class="card border-0 rounded-4 shadow py-5 card-bg">
                            <div class="px-xl-5 px-4">
                                <form action="<?php echo base_url("references/update_reference/$item->id"); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 my-3">
                                            <img class="img-fluid rounded-4" src="<?php echo base_url("uploads/references_v/$item->imgUrl"); ?>" alt="">
                                        </div>
                                    </div>
